...
return [
    ...
    */
    ...
    'active_url'           => 'Атрибут :attribute не корректный URL.',
    'after'                => 'Атрибут :attribute должна быть дата после :date.',
    'after_or_equal'       => 'Атрибут :attribute должна быть дата после или равна :date.',
    'alpha'                => 'Атрибут :attribute может содержать только буквы.',
    'alpha_dash'           => 'Атрибут :attribute может содержать только буквы, цифры и дефис/тире.',
    ...
    'between'              => [
        ...
        'array'   => 'Атрибут :attribute должен быть между :min и :max частей.',
    ],
